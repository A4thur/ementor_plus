 ...
 * @author carlo
 */
public class CadastroAlunoTurma extends javax.swing.JFrame {

    private String codigo;
    /**
     * Creates new form CadastroAlunoTurma
     */
    public CadastroAlunoTurma(String codigo) {
        this.codigo = codigo;
        initComponents();
    }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(CCpf, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(152, 152, 152)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(CCpf.getText().isEmpty()){
            ...
            AlunoTurma aluno = new AlunoTurma(CCpf.getText(), this.codigo);
            aluno.inserir();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroAlunoTurma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroAlunoTurma("").setVisible(true);
            }
        });
    }
