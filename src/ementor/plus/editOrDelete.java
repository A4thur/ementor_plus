 ...
 * @author bergamini
 */
public class editOrDelete extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editOrDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
